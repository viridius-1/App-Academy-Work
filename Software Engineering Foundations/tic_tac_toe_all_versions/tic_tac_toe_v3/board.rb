class Board 
    ...
    #method returns array of legal positions, which are those positions which haven't yet been filled  
    def legal_positions
        legals = []
        @grid.each_with_index do |row, row_idx| 
            row.each_with_index { |col, col_idx| legals << [row_idx, col_idx] if col == '_' } 
        end 
        legals 
    end 
