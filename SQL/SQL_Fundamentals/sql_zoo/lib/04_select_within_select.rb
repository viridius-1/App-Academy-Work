...
def sparse_continents
  ...
  execute(<<-SQL)
    ...
    WHERE 
      continent NOT IN (
        -- countries w/ populations >= 25 million 
        SELECT 
          continent
        FROM 
          countries 
...
#LARGER THAN RUSSIA
puts "LARGER THAN RUSSIA"
p larger_than_russia
puts "-------------------------------------"

#RICHER THAN ENGLAND 
puts "RICHER THAN ENGLAND"
p richer_than_england
puts "-------------------------------------"

#NEIGHBORS OF CERTAIN B COUNTRIES
puts "NEIGHBORS OF CERTAIN B COUNTRIES"
p neighbors_of_certain_b_countries
puts "-------------------------------------"

#POPULATION CONSTRAINT
puts "POPULATION CONSTRAINT"
p population_constraint
puts "-------------------------------------"

#SPARSE CONTINENTS
puts "SPARSE CONTINENTS"
p sparse_continents
puts "-------------------------------------"