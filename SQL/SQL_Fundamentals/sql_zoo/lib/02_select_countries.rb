...
#LARGE COUNTRIES 
puts "LARGE COUNTRIES"
p large_countries
puts "-------------------------------------"

#HIGH POPULATION GDPs
puts "HIGH POPULATION GDPs"
p high_population_gdps
puts "-------------------------------------"

#POPULATION IN MILLIONS
puts "POPULATION IN MILLIONS"
p population_in_millions
puts "-------------------------------------"

#NAME AND POPULATION
puts "NAME AND POPULATION"
p name_and_population
puts "-------------------------------------"

#UNITED WE STAND 
puts "UNITED WE STAND"
p united_we_stand
puts "-------------------------------------"