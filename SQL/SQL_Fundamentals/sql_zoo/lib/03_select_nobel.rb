...
#PRIZES FROM 1950 
puts "PRIZES FROM 1950"
p prizes_from_1950
puts "-------------------------------------"

#LITERATURE 1962
puts "LITERATURE 1962"
p literature_1962
puts "-------------------------------------"
...
#MILLENIAL PEACE PRIZES
puts "MILLENIAL PEACE PRIZES"
p millennial_peace_prizes
puts "-------------------------------------"

#EIGHTIES LITERATURE
puts "EIGHTIES LITERATURE"
p eighties_literature
puts "-------------------------------------"

#PRESIDENTIAL PRIZES
puts "PRESIDENTIAL PRIZES"
p presidential_prizes
puts "-------------------------------------"
